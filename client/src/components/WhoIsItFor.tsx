          ...
          <div className="lg:w-1/2">
            ...
            <div className="grid gap-3">
              {[
                ...
                <div key={index} className="flex items-center gap-3 bg-white p-3 rounded-lg shadow-sm border border-gray-100 hover:border-blue-200 transition-colors">
                  <CheckCircle2 className="text-[#4B73FF] h-5 w-5 flex-shrink-0" />
          ...
          <div className="lg:w-1/2 hidden lg:block relative">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl h-full min-h-[600px]">
              <img
                ...
                alt="Casal feliz realizando o sonho da maternidade"
